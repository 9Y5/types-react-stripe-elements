...
export namespace ReactStripeElements {
  ...
  type StripeProviderProps =
    | { apiKey: string; stripe?: never }
    | { apiKey?: never; stripe: StripeProps | null };
...
export class StripeProvider extends React.Component<
  ReactStripeElements.StripeProviderProps
> {}
...
export class CardNumberElement extends React.Component<
  ReactStripeElements.ElementProps
> {}

export class CardExpiryElement extends React.Component<
  ReactStripeElements.ElementProps
> {}

export class CardCVCElement extends React.Component<
  ReactStripeElements.ElementProps
> {}

export class PostalCodeElement extends React.Component<
  ReactStripeElements.ElementProps
> {}
